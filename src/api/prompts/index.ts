...
\`\`\`html
<section id="[section-id]" class="section section--[modifier]" aria-labelledby="[section-id]-heading">
  <div class="container">
...
<form id="lead-form" class="form" action="/api/leads" method="POST" novalidate>
  <div class="form__group">
    ...
    >
    <span id="name-error" class="form__error" role="alert" aria-live="polite"></span>
  </div>
  <!-- Additional fields -->
