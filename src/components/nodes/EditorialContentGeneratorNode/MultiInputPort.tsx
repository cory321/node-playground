...
// Input port configuration for Editorial Content Generator
...
// Default ports for Editorial Content Generator node
// Note: localKnowledge is now passed through the blueprint from Site Planner
export const EDITORIAL_INPUT_PORTS: InputPortConfig[] = [
	{
		id: 'blueprint',
...
export const EDITORIAL_INPUT_BASE_OFFSET = 100;
export const EDITORIAL_INPUT_SPACING = 44;
...
// Port colors for multi-input (using emerald theme for Editorial Content Generator)
const PORT_COLORS = {
	...
	return (
		<>
			{ports.map((port) => {
                ...
                ${colors.border}
                ${isHovered ? 'scale-150 shadow-[0_0_15px_rgba(16,185,129,0.6)]' : ''}
